...
import com.appify.umcaapp.recycler_adapters.AudioRecyclerAdapter;
...
public class AudioFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        audioRef = FirebaseDatabase.getInstance().getReference().child("audiomessages");
...
//    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(Audio audio);
    }
        ...
        audioRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot: dataSnapshot.getChildren()) {
                    Audio message = snapshot.getValue(Audio.class);
                    audioMessages.add(message);
                }
                adapter = new AudioRecyclerAdapter(mListener, audioMessages);
